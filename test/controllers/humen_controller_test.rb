...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference('Human.count') do
      post humen_url, params: { human: { address: @human.address, age: @human.age, name: @human.name, position: @human.position } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { address: @human.address, age: @human.age, name: @human.name, position: @human.position } }
